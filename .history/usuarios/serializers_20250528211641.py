...
class ConversacionSerializer(serializers.ModelSerializer):
    es_inicio = serializers.BooleanField(required=False, default=False, write_only=True)
    ...
    def create(self, validated_data):
        # Elimina es_inicio si viene en validated_data (porque no es parte del modelo)
